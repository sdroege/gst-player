/* GStreamer
 *
 * Copyright (C) 2014-2015 Brijesh Singh <brijesh.ksingh@gmail.com>
 *
...
gint gst_player_stream_info_get_stream_id (const GstPlayerStreamInfo *info);
const gchar* gst_player_stream_info_get_stream_type_nick (const GstPlayerStreamInfo *info);
GstTagList* gst_player_stream_info_get_stream_tags (const GstPlayerStreamInfo *info);
GstCaps* gst_player_stream_info_get_stream_caps (const GstPlayerStreamInfo *info);
...
guint gst_player_video_info_get_bitrate(const GstPlayerVideoInfo* info);
guint gst_player_video_info_get_max_bitrate(const GstPlayerVideoInfo* info);
guint gst_player_video_info_get_width(const GstPlayerVideoInfo* info);
guint gst_player_video_info_get_height(const GstPlayerVideoInfo* info);
guint gst_player_video_info_get_framerate_num(const GstPlayerVideoInfo* info);
guint gst_player_video_info_get_framerate_denom(const GstPlayerVideoInfo* info);
...
guint gst_player_audio_info_get_channels(const GstPlayerAudioInfo* info);
guint gst_player_audio_info_get_sample_rate(const GstPlayerAudioInfo* info);
guint gst_player_audio_info_get_depth(const GstPlayerAudioInfo* info);
guint gst_player_audio_info_get_bitrate(const GstPlayerAudioInfo* info);
guint gst_player_audio_info_get_max_bitrate(const GstPlayerAudioInfo* info);
...
GstPlayerMediaInfo* gst_player_media_info_new (const gchar *uri);
