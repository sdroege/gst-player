...
static void
print_media_info (GstPlay *play)
{
  GstPlayerMediaInfo *media_info;

  media_info = gst_player_get_media_info (play->player);
  if (!media_info) {
    g_print ("ERROR: failed to get media info instance. \n");
    return;
  }
...
static void
media_info_cb (GstPlayer *player, GstPlayerMediaInfo *media_info, GstPlay *play)
{
}
